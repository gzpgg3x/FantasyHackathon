...
def savepicks(request):
    ...
    print "test submit picks"



    sp = SparkPost('c0d9744155d7bbbda929d4e6f4b2822cc1355052')

    response = sp.transmission.send(
        recipients=['guoqianp@gmail.com'],
        html='<p>Hello Winner</p>',
        from_email=' <fantasy hackathon> jin@elegantfelt.com',
        subject='You have won Fantasy Hackathon for Angel Hack Brooklyn'
    )
